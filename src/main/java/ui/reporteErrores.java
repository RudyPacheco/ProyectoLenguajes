...
public class reporteErrores extends javax.swing.JFrame {
    ...
    public reporteErrores(JFrame pantalla,ArrayList erroresR) {
        initComponents();
        this.pantallaR= pantalla;
        this.errores=erroresR;
        reporte.recibirErrores(erroresR);
        reporte.reporteErrores(jTableErrores);
    ...
    private void initComponents() {
        ...
        jLabelTitulo.setText("Reporte Errores");
